        ...
        <div className="mt-40 pt-10">
            ...
            <div className='mt-8'>
                ...
                <div className='lg:flex items-center'>
                    <img className='animated-image w-[500px] h-[450px]' src={img1} alt="" />
                    <div className='space-y-2'>
                ...
                <div className='lg:flex items-center'>
                    ...
                    <img className='animated-image w-[500px] h-[450px]' src={img2} alt="" />
                </div>
                {/* 3rd card */}
                <div className='lg:flex items-center'>
                    <img className='animated-image w-[500px] h-[450px]' src={img3} alt="" />
                    <div className='space-y-2'>
                ...
                <div className='lg:flex items-center'>
                    ...
                    <img className='animated-image  w-[500px] h-[450px]' src={img4} alt="" />
                </div>
            </div>
        </div>
    );
